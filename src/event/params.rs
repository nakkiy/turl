...
pub fn handle_events(app: &mut App, key_event: KeyEvent) -> io::Result<bool> {
    match key_event.modifiers {
        KeyModifiers::CONTROL => match key_event.code {
            KeyCode::Char('d') => {
                app.request.params.remove(app.ui.selected_index);
    ...
    match key_event.code {
        KeyCode::Down => {
            if app.ui.selected_index < app.request.params.len() - 1 {
        ...
        KeyCode::Up => {
            if 0 < app.ui.selected_index {
                ...
                app.ui.selected_index = app.request.params.len() - 1;
            }
            app.ui
                .list_states
                .params
        ...
        KeyCode::Enter => {
            ...
            app.ui.popup.state = PopupState::Params;
            app.ui.popup.key = TextArea::new(vec![app.request.params[app.ui.selected_index]
                .0
                .to_string()]);
            app.ui.popup.value = TextArea::new(vec![app.request.params[app.ui.selected_index]
                .1
                .to_string()]);
